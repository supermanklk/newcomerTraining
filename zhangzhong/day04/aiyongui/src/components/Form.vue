...
<template>
  <div id="from">
    ...
    <div class="conent">
      ...
      <div class="lood">
        <p class="p">任务说明：</p>
        <textarea class="box" v-model=" obj.position_instructions"></textarea>
      </div>
      <el-container class="list">
        <el-header class="Header">
          ...
          <div class="btn3">
            <div class="first">
              <el-button class="min">全部</el-button>
              <el-button class="min">已报名</el-button>
              <el-button class="min">待报名</el-button>
            </div>
            <div class="sce">
  ...
  methods: {
    fiffer(arr,res){
      ...
      let newArr = arr.map((item) => {
        item.sname = res.data[0].id_card_number;
        item.name = res.data[0].username;
        item.numsate = res.data[0].business_license;
        item.tel = res.data[0].tel;
        item.sate = res.data[0].certification_status;
        item.time = res.data[0].apply_check_time;
        return item
      })
      this.statep =1
      return newArr
      ...
      if (value == ""){
        ...
        fetch(url,{
          ...
          body: opt,
            ...
            .then((res) => {
              this.fiffer(this.tableData,res)
            });
      }
    },
  },
